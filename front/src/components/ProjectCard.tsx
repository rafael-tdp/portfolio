    ...
    <div className="project-card flex w-full flex-row">
      <div className="flex flex-col w-full z-30">
        {href ? (
            ...
            >
              ...
              {image && (
                <Image
                  ...
                  width={1200}
                  height={753}
                  className={`lg:group-hover:translate-y-10 w-full max-w-[85%] translate-y-1 md:translate-y-2 -rotate-3 rounded-t-lg border-[1.5px] border-white/20 transition-all duration-300 will-change-transform lg:block lg:rotate-0 lg:group-hover:scale-[1.08] lg:group-hover:-rotate-3`}
          ...
          <div className="relative cursor-default overflow-hidden rounded-xl border border-gray-400/15 bg-slate-950 dark:bg-transparent dark:border-white/15 p-1 shadow-lg md:shadow-2xl h-[250px] md:h-[450px] lg:rounded-3xl lg:p-1.5 group">
            <div
              className="absolute inset-x-0 top-0 h-px"
              style={{
                background:
