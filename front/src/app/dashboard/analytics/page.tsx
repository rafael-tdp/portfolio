...
function AnalyticsContent() {
  ...
  function getSourceIcon(source: string) {
    ...
    if (s.includes("linkedin")) return <FaLinkedin className="w-4 h-4 text-[#0077b5]" />;
    if (s.includes("mail.google") || s.includes("outlook") || s.includes("mail.")) return <LuMail className="w-4 h-4 text-red-500" />;
    if (s.includes("google")) return <FaGoogle className="w-4 h-4 text-[#4285f4]" />;
    if (s.includes("twitter") || s.includes("x.com")) return <FaTwitter className="w-4 h-4 text-[#1da1f2]" />;
  ...
  function getFilledDays() {
    if (!analytics) return [];
    const days: Array<{ date: string; count: number; uniqueVisitors: number }> = [];
    ...
    for (let i = 29; i >= 0; i--) {
      ...
      const existing = analytics.visitsByDay.find((v) => v.date === dateStr);
      days.push({
        date: dateStr,
    ...
    <div className="min-h-screen px-4 py-4 sm:p-6 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-semibold">Analytics détaillés</h1>
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-400">Visites totales</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-400">Visiteurs uniques</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-400">Scroll moyen</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6">
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-semibold text-gray-800">Visites par jour</h2>
            </div>
                ...
                {filledDays.map((day) => (
                  ...
                  >
                    <div
                      ...
                      style={{
                        height: day.count > 0 ? `${Math.max((day.count / maxDayVisits) * 100, 8)}%` : "3px",
                    ...
                    <div className="absolute bottom-full mb-2 hidden group-hover:block z-10 pointer-events-none">
                      <div className="bg-gray-800 text-white text-xs rounded px-2 py-1.5 whitespace-nowrap shadow-lg">
                        ...
                        <div>{day.count} visite{day.count !== 1 ? "s" : ""}</div>
                        <div className="text-gray-300">{day.uniqueVisitors} unique{day.uniqueVisitors !== 1 ? "s" : ""}</div>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-semibold text-gray-800">Visites par heure</h2>
            </div>
            <div className="h-48 sm:h-56 flex flex-col">
              {/* Chart area */}
              <div className="flex-1 flex items-end gap-[2px] sm:gap-1 min-h-0">
                {filledHours.map((hour) => (
                  ...
                  >
                    <div
                      ...
                      style={{
                        height: hour.count > 0 ? `${Math.max((hour.count / maxHourVisits) * 100, 8)}%` : "3px",
                        minHeight: hour.count > 0 ? "12px" : "3px",
                      }}
                    />
                    {/* Tooltip */}
                    <div className="absolute bottom-full mb-2 hidden group-hover:block z-10 pointer-events-none">
                      <div className="bg-gray-800 text-white text-xs rounded px-2 py-1.5 whitespace-nowrap shadow-lg">
                        <div className="font-medium">{hour.hour}h - {hour.hour + 1}h</div>
                        <div>{hour.count} visite{hour.count !== 1 ? "s" : ""}</div>
                      </div>
                    </div>
                  </div>
                ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6">
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-semibold text-gray-800">Appareils</h2>
            </div>
            {analytics?.deviceStats && analytics.deviceStats.length > 0 ? (
              <div className="space-y-3">
                {analytics.deviceStats.map((stat) => {
                  const percentage = Math.round((stat.count / analytics.totalVisits) * 100);
                  return (
                    <div key={stat.device}>
                      <div className="flex items-center justify-between text-sm mb-1">
                        <div className="flex items-center gap-2">
                          {getDeviceIcon(stat.device)}
                          <span className="text-gray-700">{stat.device}</span>
                        </div>
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-semibold text-gray-800">Navigateurs</h2>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6">
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-semibold text-gray-800">Sources de trafic</h2>
            </div>
                    ...
                    <div key={stat.source}>
                      <div className="flex items-center justify-between text-sm mb-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-700">{getSourceLabel(stat.source)}</span>
                        </div>
                        <span className="text-gray-500">
                          {stat.count} ({percentage}%)
                        </span>
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-semibold text-gray-800">Sections consultées</h2>
            </div>
              ...
              <div className="space-y-3">
                {analytics.sectionStats.map((stat) => {
                  const percentage = analytics.totalVisits > 0 
                    ? Math.round((stat.count / analytics.totalVisits) * 100) 
                    : 0;
                  return (
                    <div key={stat.key}>
                      <div className="flex items-center justify-between text-sm mb-1">
                        <span className="text-gray-700">{stat.section}</span>
                        <span className="text-gray-500">
                          {stat.count} ({percentage}%)
                        </span>
                      </div>
        ...
        <div className="bg-white rounded-xl border border-gray-100 mb-6 overflow-hidden">
          <div className="px-4 sm:px-5 py-3 sm:py-4 border-b border-gray-100 bg-gray-50/50">
            <h2 className="font-semibold text-gray-800">Top candidatures</h2>
          </div>
          {analytics?.topApplications && analytics.topApplications.length > 0 ? (
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="w-8 h-8 rounded-full bg-gradient-to-br from-gray-100 to-gray-50 flex items-center justify-center text-sm flex-shrink-0">
                        {getDeviceIcon(getDeviceFromUA(activity.userAgent))}
                      </div>
                      <div className="min-w-0">
                        <div className="text-sm font-medium text-gray-800 truncate">
                          {activity.companyName || "Entreprise"}
                        </div>
                        <div className="text-xs text-gray-400 truncate">
                  ...
                  <div className="ml-11 flex flex-wrap items-center gap-2 text-xs">
                    ...
                    {activity.sectionsViewed && (
                      <>
                        ...
                        {activity.sectionsViewed.coverLetter && (
